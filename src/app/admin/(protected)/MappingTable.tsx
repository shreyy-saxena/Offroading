          ...
          <table className="w-full text-left text-caption">
            <thead>
              <tr className="text-muted">
                <th className="py-1 pr-4 font-medium">District</th>
                <th className="py-1 font-medium">Authority email</th>
              </tr>
            </thead>
            <tbody>
              {mapping.map((entry) => (
                <tr key={entry.district} className="border-t border-hairline">
                  <td className="py-2 pr-4 text-ink">{entry.district}</td>
                  <td className="py-2 text-ink">{entry.authorityEmail}</td>
                </tr>
              ))}
            </tbody>
          </table>
